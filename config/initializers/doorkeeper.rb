Doorkeeper.configure do
  Octopus.using(:gman_services) do
    ...
    # If you want to restrict access to the web interface for adding
    # oauth authorized applications, you need to declare the block below.
    ...
    # to enforce ownership of
    # a registered application
    # Note: you must also run the rails g doorkeeper:application_owner
    # generator to provide the necessary support
    ...
    # falls back to the `:client_id` and `:client_secret`
    # params from the `params` object.
    ...
    # Use nil to disable this feature. When disabled,
    # clients must provide a valid URL
    #
    # native_redirect_uri 'urn:ietf:wg:oauth:2.0:oob'

    # Forces the usage of the HTTPS protocol in non-native
